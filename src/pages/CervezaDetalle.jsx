...
export default function CervezaDetalle() {
  ...
  const imagenUrl = cerveza.imatge
    ? `${BASE_UPLOADS}${cerveza.imatge.replace(/^uploads[\\/]/, "")}`
    : null;
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-16 items-start">
        ...
        <div className="flex flex-col gap-8 pt-2">
          <div>
            ...
            <h1
              className="text-4xl font-bold text-amber-900 leading-tight mb-4"
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              style={{
                backgroundColor: añadido ? "var(--color-gold)" : "#92400e",
                color: añadido ? "#92400e" : "white",
              }}
            >
          ...
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-xs text-[var(--color-text-muted)] hover:text-amber-800 transition w-fit"
          >
